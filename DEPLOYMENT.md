...
3. Publicar. O build executa as migrações do banco e compila o frontend. Se a conexão com o banco estiver ausente, o deploy falha em vez de publicar formulários sem persistência.
